...
/*
*
* Добрый день! Проект создан что бы вместить все лабораторные работы по предмету Технологии программирования.
* Поэтому были созданы заголовочные файлы отдельно по лабораторным работам так 
* и общие заголовные файлы и вспомогательные файлы хранящие вспомогвтельные функции
...
* Ссылка на репозиторий https://github.com/gkwd/PT-labs
*
*/
